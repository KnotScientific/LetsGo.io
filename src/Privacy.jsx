  ...
  <div>
    <div data-custom-class="body">
      ...
      <div style={{ textAlign: "center" }}>
        <strong>
          <span style={{ fontSize: 26 }} data-custom-class="title">
            PRIVACY NOTICE
          </span>
        </strong>
        <div>
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <p data-custom-class="body_text">
              Thank you for choosing to be part of our community at LetsGo. ("
              ...
              information, please contact us at letsgodining@gmail.com.
            </p>
            <p>
            ...
            <ul>
              ...
              >
                Download and use our mobile application — LetsGo
              </li>
            </ul>
            <ul>
              <li
            ...
            <ul>
              ...
              >
                ...
                ours that link to this policy, including any listed above
              </li>
            </ul>
            <ul>
              <li
      ...
      <div
        style={{ lineHeight: "1.5", fontSize: 17, color: "rgb(89, 89, 89)" }}
      >
        <h2 style={{ color: "rgb(0, 0, 0)", fontSize: 20 }}>
        ...
        <p>
          <u>2. How do we use your information?</u>
        </p>
        <p>
          <u>3. Will your information be shared with anyone?</u>
        </p>
        <p>
          <u>4. Who will your information be shared with?</u>
        </p>
        <p>
          <u>5. Do we use cookies and other tracking technologies?</u>
        </p>
        <p>
          <u>6. How do we handle your social logins?</u>
        </p>
        <p>
          <u>7. What is your stance on third party websites?</u>
        </p>
        <p>
          <u>8. How long do we keep your information?</u>
        </p>
        <p>
          <u>9. How do we keep your information safe?</u>
        </p>
        <p>
          <u>10. What are your privacy rights?</u>
        </p>
        <p>
          <u>11. Controls for Do-Not-Track features</u>
        </p>
        <p>
          <u>12. Do California residents have specific rights?</u>
        </p>
        <p>
      ...
      >
        <strong>
          <h2 style={{ fontSize: 20, color: "rgb(0, 0, 0)" }}>
            1. WHAT INFORMATION DO WE COLLECT?
          </h2>
        </strong>
        <h3 style={{ color: "rgb(0, 0, 0)", fontSize: 17 }}>
        ...
        <p>
          ...
          names; phone numbers; email addresses; usernames; passwords; phone
        ...
        <p>
          ...
          <u>"How we handle your social logins?"</u> below.
        </p>
        <p>
        ...
        <ul>
          <li style={{ lineHeight: "1.5" }}>
            ...
            settings of the device you use to access the App. For example, we
        ...
        <h3 style={{ fontSize: 17, marginTop: 0, color: "rgb(0, 0, 0)" }}>
          <br />
        ...
        <ul>
          <li style={{ lineHeight: "1.5" }}>
            ...
            device's contacts, sms messages, social media accounts, and other
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 20, marginTop: 25 }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
      ...
      <div style={{ lineHeight: "1.5", marginTop: 25 }}>
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
        ...
        <li style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              of the contract. See the section below headed "
              <u>How do we handle your social logins?</u>" for further
              information.
            </span>
          </span>
        </li>
        ...
        <li style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              testimonial, please contact us at letsgodining@gmail.com and be
        ...
        <li style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              information as part of our efforts to keep our App safe and secure
        ...
        <li style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              about us or our App, subscribing to marketing or otherwise
        ...
        <li style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              promotional campaigns and to evaluate and improve our App,
        ...
        <li style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              (https://policies.google.com/privacy). We obtain and store on your
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              titled "<u>How can you contact us about this notice?</u>".
            </span>
          </span>
        </span>
      </div>
          ...
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              <em>
                ...
                of any information that you share with third-party providers who
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              services or mobile applications. We cannot guarantee the safety
              ...
              the App. You should review the policies of such third parties and
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              may email us at letsgodining@gmail.com.
            </span>
          </span>
        </span>
      </div>
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              our App. To opt-out of interest-based advertising by advertisers
              on our App visit http://www.aboutads.info/choices/.
            </span>
          </span>
        </span>
      </div>
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              ou can unsubscribe from our marketing email list at any time by
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 20, marginTop: 15 }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <h2 data-custom-class="heading_1">
      ...
      <table style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
        <tbody>
          <tr>
            <th>Category</th>
            <th>Examples</th>
          ...
          <tr>
            <td>I. Professional or employment-related informations</td>
            <td>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ color: "rgb(89, 89, 89)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            ...
            <p data-custom-class="body_text">
              LetsGo. collects and shares your personal information through:
            </p>
            <ul>
              <li style={{ lineHeight: "1.5" }}>
                Facilitation in the delivery of our Services and to respond to
            ...
            <p data-custom-class="body_text">
              ...
              disabling cookies in Cookie Preference Settings and clicking on
              the Do Not Sell My Personal Information link on our homepage.
            </p>
            <p data-custom-class="body_text">
              You may contact us by email at letsgodining@gmail.com, or by
            ...
            <p data-custom-class="body_text">
              LetsGo. has disclosed the following categories of personal
            ...
            <p data-custom-class="body_text">
              LetsGo. has sold the following categories of personal information
            ...
            <ul>
              <li style={{ lineHeight: "1.5" }}>Ad Networks</li>
            </ul>
            <ul>
              <li style={{ lineHeight: "1.5" }}>
                Affiliate Marketing Programs
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
          ...
          <p data-custom-class="body_text">
            ...
            letsgodining@gmail.com, or by referring to the contact details at
      ...
      >
        ...
        <p>
          ...
          at info@letsgoapp.io or by post to:
        </p>
        <br />
        <span>LetsGo.</span>
        <br />
        <span>19 McEwan Drive West</span>
        <br />
        <span>Bolton, ON L7E1G2</span>
        <br />
        <span>Canada</span>
      </div>
      <div
